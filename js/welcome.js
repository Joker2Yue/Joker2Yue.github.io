...
function showWelcome() {
    var e, a, t = getDistance(111.010884,27.111502, ipLocation.result.location.lng, ipLocation.result.location.lat),
    ...
    try {
        document.getElementById("welcome-info").innerHTML = '欢迎来自 <b><span style="color: var(--joker2yue-ip-color);font-size: var(--joker2yue-gl-size)">'.concat(r, "</span></b> 的宝子🥰<br>").concat(a, '🍂<br>当前位置距博主约 <b><span style="color: var(--joker2yue-ip-color)">').concat(t, "</span></b> 公里！<br>您的IP地址为：<b><span>").concat(e, "</span></b><br>").concat(n, " <br>")
    } catch (e) {
